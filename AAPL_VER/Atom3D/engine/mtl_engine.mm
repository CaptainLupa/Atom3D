...
void MTLEngine::setSize(float x, float y) {
    mViewSize = {x, y};
}
...
// One time setup.
void MTLEngine::createDefaultLib() {
...
void MTLEngine::encodeRenderCommand(MTL::RenderCommandEncoder* rce) {
...
void MTLEngine::frameBufferSizeCallback(GLFWwindow* window, int width, int height) {
    MTLEngine* woah = (MTLEngine*)glfwGetWindowUserPointer(window);
